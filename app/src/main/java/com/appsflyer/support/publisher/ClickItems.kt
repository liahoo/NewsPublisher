    ...
    fun init(context: Context) {
        ...
        gameAdsRetargeting = listOf(
                ClickItem(1, null, R.mipmap.mm_discount_dp,
                        targetUrl = "https://candyapp.onelink.me/4IvE?pid=ypartner_int&c=publisherapps&af_adset=deeplink&af_ad=MM&af_adset_id=iMM-ddl&af_siteid=CG-123&af_cost_currency=USD&af_cost_value=12&af_dp=candyapp%3A%2F%2FMM&discount=15&advertising_id=${PublisherApp.gaid}&clickid={epoch-time-adid}",
                ...
                ClickItem(1, null, R.mipmap.skittles_discount_dp,
                        targetUrl = "https://app.appsflyer.com/com.candyapp.appsflyer?pid=ypartner_int&c=publisherapps&af_adset=deeplink&af_ad=Skittles&af_adset_id=iSK-ddl&af_siteid=CG-123&af_cost_currency=USD&af_cost_value=19&is_retargeting=true&af_dp=candyapp%3A%2F%2FSkittles&discount=10&advertising_id=${PublisherApp.gaid}&clickid={epoch-time-adid}",
                        impressUrl = "https://impression.appsflyer.com/com.candyapp.appsflyer?pid=ypartner_int&c=publisherapps&af_adset=deeplink&af_ad=Skittles&af_adset_id=iSK-ddl&af_siteid=CG-123&af_cost_currency=USD&af_cost_value=19&is_retargeting=true&advertising_id=${PublisherApp.gaid}&clickid={epoch-time-adid}") ,
                ClickItem(1, null, R.mipmap.reengage_id_matching,
                        targetUrl = "https://app.appsflyer.com/com.candyapp.appsflyer?pid=ypartner_int&c=publisherapps&af_adset=reengagement_via_id_matching&af_siteid=CG-123&af_cost_currency=USD&af_cost_value=12&is_retargeting=true&advertising_id=${PublisherApp.gaid}&clickid={epoch-time-adid}",
                        impressUrl = "https://impression.appsflyer.com/com.candyapp.appsflyer?pid=ypartner_int&c=publisherapps&af_adset=reengagement_via_id_matching&af_siteid=CG-123&af_cost_currency=USD&af_cost_value=19&is_retargeting=true&advertising_id=${PublisherApp.gaid}&clickid={epoch-time-adid}")
        )
    }
}